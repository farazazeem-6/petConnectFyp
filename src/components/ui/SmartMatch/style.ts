...
export const OptionRow = styled('button', {
  ...
  transition:
    'border-color 0.15s ease, background 0.15s ease, transform 0.12s ease',
...
export const SmartMatchButton = styled('button', {
  ...
  transition:
    'background 0.2s ease, color 0.2s ease, transform 0.12s ease, box-shadow 0.2s ease',
  ...
  '&::before': {
    ...
    inset: 0,
    background:
      'linear-gradient(120deg, transparent 0%, rgba(24, 167, 43, 0.07) 50%, transparent 100%)',

...
export const ChatHeader = styled(Flex, {
    ...
    padding: '$px$12 $px$16',
    background: 'linear-gradient(135deg, $main 0%, #a83258 100%)',
    flexShrink: 0,
    gap: '$px$10',
});
...
export const BotAvatarSmall = styled(Box, {
    ...
    flexShrink: 0,
    alignSelf: 'flex-end',
    boxShadow: '0 2px 8px rgba(139, 32, 66, 0.25)',
});
    ...
    variants: {
        role: {
            user: {
                ...
                boxShadow: '0 2px 8px rgba(139, 32, 66, 0.2)',
            },
            assistant: {
                backgroundColor: '$white',
                color: '$textPrimary',
...
export const WelcomeAvatar = styled(Box, {
    ...
    height: '56px',
    borderRadius: '$radius$full',
    background: 'linear-gradient(135deg, #fff5f7 0%, #fce4eb 100%)',
    border: '2px solid #f4c2cf',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    marginBottom: '$px$4',
...
export const SendButton = styled('button', {
    ...
    justifyContent: 'center',
    flexShrink: 0,
    boxShadow: '0 3px 10px rgba(139, 32, 66, 0.3)',
    transition: 'transform 0.15s ease, box-shadow 0.15s ease, opacity 0.15s ease',
    '&:hover': {
        transform: 'scale(1.08)',
        boxShadow: '0 5px 16px rgba(139, 32, 66, 0.45)',
    },
    '&:active': { transform: 'scale(0.94)' },
    variants: {
        disabled: {

...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    ...
    >
      ...
      c0.569,1.893,2.564,2.969,4.458,2.397c0.314-0.094,0.606-0.229,0.871-0.396l3.286,3.229 
      c-0.082,1.048,0.394,2.396,1.689,4.185c2.305,3.186,5.818,7.044,12.252,5.04 
      c5.474-1.705,0.621-7.639,2.719-11.315c0.113-0.197,0.197-0.386,0.26-0.561l1.572-2.144 
